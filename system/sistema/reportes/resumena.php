...
$pdf->Cell(60,12,utf8_decode('BENEFICIO '.$result['ru_descripcion']),0,0,'C');
$pdf->SetFont('Arial','B',8);
...
$pdf->Cell(90,12,utf8_decode(''),0,0,'C');
$pdf->SetFont('Arial','',6);
if($_GET['mu']>0){
...
$pdf->SetFont('Arial','B',8);
$pdf->Ln(8);
$pdf->Cell(190,5,utf8_decode('II. REGISTRO DE BENEFICIO DE '.$result['ru_descripcion']),1,0,'L');
$pdf->Cell(50,5,utf8_decode(''),0,1,'C');
$pdf->SetFont('Arial','',8);
$pdf->Cell(110,10,utf8_decode('TIPO DE PRODUCTO'),1,0,'C');
$pdf->Cell(30,10,utf8_decode('TOTAL'),1,0,'C');
$pdf->Cell(50,5,utf8_decode('DISTRIBUCION DE LA PRODUCCION'),1,1,'C');
$pdf->Cell(110,10,utf8_decode(''),0,0,'C');
$pdf->Cell(30,10,utf8_decode(''),0,0,'C');
$pdf->Cell(25,5,utf8_decode('EMBASADORA'),1,0,'C');	
$pdf->Cell(25,5,utf8_decode('INDUSTRIA'),1,0,'C');
$pdf->Ln(5);
$queryp = "SELECT rt.rut_descripcion,SUM(pd.prd_cantidad)  as cantidad  from produccion_detalle pd, produccion p, rubro_tipo rt, establecimiento e, municipio m where p.pr_estcodigo=e.est_codigo and e.est_muncodigo=m.mun_codigo and p.pr_codigo=pd.prd_prcodigo and pd.prd_rutcodigo=rt.rut_codigo AND p.pr_estado='ACTIVA' and pd.prd_estado='ACTIVA'";
if($_GET['m']>0){
...
while ($resultp = mysqli_fetch_array($querypg)){
	...
	$pdf->Cell(25,5,utf8_decode($resultd1['prd_cantidad']/1),1,1,'C');
}
$pdf->Output();
?>