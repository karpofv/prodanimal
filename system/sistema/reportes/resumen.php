...
$pdf->Cell(170,12,utf8_decode(''),0,0,'C');
...
$pdf->Cell(90,10,utf8_decode('MUNICIPIO'),1,0,'C');
$pdf->Cell(80,10,utf8_decode('TIPO DE ANIMAL'),1,0,'C');
$pdf->Cell(30,10,utf8_decode('Nº DE CABEZAS'),1,0,'C');
$pdf->Cell(50,5,utf8_decode('TOTAL KILOGRAMOS'),1,1,'C');
$pdf->Cell(200,10,utf8_decode(''),0,0,'C');
$pdf->Cell(30,10,utf8_decode(''),0,0,'C');
$pdf->Cell(25,5,utf8_decode('EN PIE'),1,0,'C');	
$pdf->Cell(25,5,utf8_decode('EN CANAL'),1,0,'C');
$pdf->Ln(5);
...
$pdf->Cell(30,10,utf8_decode('MES'),1,0,'C');
$pdf->Cell(90,10,utf8_decode('MUNICIPIO'),1,0,'C');
$pdf->Cell(80,10,utf8_decode('CATEGORIA	'),1,0,'C');
$pdf->Cell(30,10,utf8_decode('Nº DE CABEZAS'),1,0,'C');
$pdf->Cell(50,5,utf8_decode('TOTAL KILOGRAMOS'),1,1,'C');
$pdf->Cell(200,10,utf8_decode(''),0,0,'C');
$pdf->Cell(30,10,utf8_decode(''),0,0,'C');
...
if($_GET['c']>0){
	$queryp.=" and prd_rucatcodigo=".$_GET['c'];
}
$queryp.= " GROUP BY rt.rut_descripcion order by mun_descrip" ;
$querypg = mysqli_query($queryp);
while ($resultp = mysqli_fetch_array($querypg)){
