            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <table id="tbdestinos" class='stripe' cellspacing='0' width='100%'>
                        ...
                        <tbody class="body">
                            <?php
                            $consulprod = paraTodos::arrayConsulta("*", "produccion_procede", "prpr_prcodigo=$codigo");
                            foreach ($consulprod as $post) {
                                ?>
                                <tr>
                                    <td><?php echo $post['prpr_entidad']; ?></td>
                                    <td><?php echo $post['prpr_unidad']; ?></td>
                                    <td><a href="javascript:void(0);" onclick="controler('dmn=<?php echo $idMenu ?>&ver=1&selrubro=<?php echo $selrubro; ?>&codigo=<?php echo $codigo; ?>&codigodet=<?php echo $post['prpr_codigo'];?>&eliminar=1', 'verContenido', '');">Eliminar</a></td>
                                </tr>
                                <?php
                            };
                            ?>
